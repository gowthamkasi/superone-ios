...
/// Dedicated package booking date and time selection view
/// Replaces modal sheet with full-page navigation flow
struct PackageBookingDateTimeView: View {
    ...
    private var mainContentWithoutHeader: some View {
        ScrollView {
            LazyVStack(spacing: HealthSpacing.xl) {
                // Header section with package details
                if let package = packageDetails {
    ...
    // MARK: - Package Header Card
    private func packageHeaderCard(package: HealthPackage) -> some View {
        HStack(spacing: HealthSpacing.md) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("\(package.totalTests) tests • \(package.duration)")
    ...
    private var instructionsSection: some View {
        VStack(alignment: .leading, spacing: HealthSpacing.md) {
            ...
            Text("Choose your preferred date and time slot for the health package. Our team will confirm the appointment within 2 hours and provide detailed preparation instructions.")
                .healthTextStyle(.body, color: HealthColors.secondaryText)
                .multilineTextAlignment(.leading)
        }
        .cardPadding()
